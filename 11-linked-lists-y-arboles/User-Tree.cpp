 ...
 * Costo operacional: O(N) ya que se recorren todos los nodos del árbol pasado como argumento
...
/* Justificación de costos:
 - Siendo N la cantidad de nodos del árbol pasado como argumento.
 * Costo operacional: O(N) ya que se recorren todos los nodos del árbol pasado como argumento
 * Costo en memoria: O(N), siendo N la cantidad de frames que se crean en memoria ya que la función es recursiva. 
 */
...
/* Justificación de costos:
 - Siendo N la cantidad de nodos del árbol pasado como argumento.
 * Costo operacional: O(N) ya que se recorren todos los nodos del árbol pasado como argumento
 * Costo en memoria: O(N) en peor caso ya que  
 */
